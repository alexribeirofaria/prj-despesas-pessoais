...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, FormsModule, MatIconModule, MatFormFieldModule, MatInputModule, SharedModule],
...
export class AcessoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.createAccountFrom = this.formbuilder.group({
      ...
      validators: CustomValidators.isValidPassword  // corrigido aqui
    });
  }
